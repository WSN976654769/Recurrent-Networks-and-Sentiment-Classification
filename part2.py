...
class NetworkLstm(tnn.Module):
    ...
    def __init__(self):
        ...
        """
        self.lstm = tnn.LSTM(50,hidden_size =100,batch_first=True)  
...
class NetworkCnn(tnn.Module):
    ...
    def __init__(self):
        ...
        Create and initialise weights and biases for the layers.
        """
        self.conv1d = tnn.Conv1d(50,50, kernel_size=8, padding=5)
        self.pool = tnn.MaxPool1d(kernel_size = 4)
        self.maxpool = tnn.AdaptiveMaxPool1d(1)
